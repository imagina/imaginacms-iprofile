<div wire:init="reload(window.location)" id="{{ $ident }}" class="d-inline-block">
  ...
  @if($user)
    ...
    <div class="account-menu dropdown d-inline-block" id="accMenuDrop">
      <button class="btn dropdown-toggle {{$classUser}}" type="button" role="button" id="dropdownProfile"
        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="dropdown profile">
      ...
      <div id="drop-menu" class="dropdown-menu dropdown-menu-right">
        ...
        @endforeach
        <a class="dropdown-item cursor-pointer" wire:click="logout" data-placement="bottom" title="Sign Out">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            --}}
            @includeFirst(['iprofile.widgets.login', 'iprofile::frontend.widgets.login'], ["embedded" => true, "register" => false])
          </div>
        </div>
      </div>
    </div>
  ...
  @if($openRegisterInModal)
    <!-- User register modal -->
    <div class="modal fade" id="userRegisterModal" tabindex="-1" aria-labelledby="userRegisterModalLabel"
      aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
